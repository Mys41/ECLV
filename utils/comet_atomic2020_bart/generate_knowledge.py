...
if __name__ == "__main__":
    ...
    for split in ["train", "test", "valid"]:
        ...
        emotion_label, ids = pickle.load(open('../../data/dailydialog_' + split + '.pkl', 'rb'), encoding='latin1')
        map1 = get_csk_feature(model, tokenizer, target_context, relations_social)
        pickle.dump(map1, open('../../data/dailydialog_csk_social_' + split + '.pkl', "wb"))
    ...
    for split in ["train", "test", "valid"]:
        ...
        pickle.dump(map1, open('../../data/dailydialog_csk_event_' + split + '.pkl', "wb"))
